...
int main(){
    ...
    if(i==7){
        ...
        printf("5) Which of the following is not a darabase managment software?\n\n");
    ...
    if(ans1==2 && ans2==4 && ans3==4 && ans4==1 && ans5==3){
        point6 = point1 + point2 + point3 + point4 + point5;
        printf("Your total score is: %d",point6);
    }
    else{
